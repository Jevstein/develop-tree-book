...
static Napi::String GetDir(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  std::string funcname = "getDir";
  std::string path = PathAdapter::GetDir(funcname);
...
static Napi::Object Init(Napi::Env env, Napi::Object exports) {
  ...
  exports.Set(Napi::String::New(env, "getDir"),
              Napi::Function::New(env, GetDir));
  return exports;
}
