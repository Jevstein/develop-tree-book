...
https://mp.weixin.qq.com/s/TMOaK5OVkLwAKkAMT9aRmw

编者荐语：

本文为为小林coding投稿，作者小林，文章写的很用心，大家感兴趣可以关注一波

以下文章来源于小林coding ，作者小林coding

[![小林coding](http://wx.qlogo.cn/mmhead/Q3auHgzwzM5Kh6QZ0Kow3MJCcPpZ8cuUYLqX1lKhg5ibniaYIOCDQMGw/0)**小林coding**用简洁的方式，分享编程小知识。](https://mp.weixin.qq.com/s?__biz=MzAwMjk5Mjk3Mw==&mid=2247488692&idx=3&sn=778926313214595a6f30b4f7424fbb5c&chksm=9ac0aa96adb723809133c27b21b866b023368c335a691701c644b4e9c5c84bc6b2c9cef3c73d&mpshare=1&scene=1&srcid=0420nQAZTzSOx7f4ThhMaC6y&sharer_sharetime=1587343492532&sharer_shareid=646edd1d312fa8975bbdf6fe003f85f4&key=ccd5ddabfc375191ca1ba2b66a17a514bd06af4cfe79dc6920a27765cb3a4c22a5c622418148b0638bb4cc87933785006512c4a5398d1489883d60da34cafd198589e1250cde5e8c2330ed85b99ec8e3&ascene=1&uin=ODUyNDUyMTI0&devicetype=Windows+7&version=62080079&lang=zh_CN&exportkey=AfWBwDJfF4SkV7sBP86Pu8o%3D&pass_ticket=FxOI1xdOYeB3YgXRCr0jK5eWjb%2BLT%2BPyedWC1zIB0OjD3vdk%2BJhGvScg7CN7kPe8&winzoom=1#)
...
![提纲](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg==)提纲
...
![正常的数据传输](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg==)正常的数据传输
...
![超时重传的两种情况](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZeuicRMlA8rKvl5AVLibhibDhgObdlvOJianvD0oj586rMc8wVs4hlzUtgRibWfD0WBpAJhRtHxOPd9ibibQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)超时重传的两种情况
...
![超时时间较长与较短](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZeuicRMlA8rKvl5AVLibhibDhgyx80wY6Zsy2xW0U5egNib7icspUPsE9PKYq5WLaoJGpkTIoZ1c5gIjCw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)超时时间较长与较短
...
![按数据包进行确认应答](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZeuicRMlA8rKvl5AVLibhibDhgMiaZvYzVsKCCVTHJZw1GR6cI49iaw7XVQCNhomJJibSc0icN5mnA7Zvkog/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)按数据包进行确认应答
...
![可用窗口耗尽](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZeuicRMlA8rKvl5AVLibhibDhg3ZL5YZicgaInXFFlibY8KD1ibMaqndGybEBEwHCMYlzibX6aupGA11OI1A/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)可用窗口耗尽

在下图，当收到之前发送的数据 `32~36` 字节的 ACK 确认应答后，如果发送窗口的大小没有变化，则**滑动窗口往右边移动 5 个字节，因为有 5 个字节的数据被应答确认**，接下来 `52~56` 字节又变成了可用窗口，那么后续也就可以发送 `52~56` 这 5 个字节的数据了。

![32 ~ 36 字节已确认](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZeuicRMlA8rKvl5AVLibhibDhg64rlHPQwlXs1DCnT0zapq7hbeziazJ7mQ4ZFCtwRIwkg4gfFaxDoudg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)32 ~ 36 字节已确认
...
![接收窗口](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZeuicRMlA8rKvl5AVLibhibDhglnibEWRdZcD4QWuC61y9iaRoKlWUWyicnP0iaS01fAjsdGgKJnYJcfm0wA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)接收窗口
...
![img](http://wx.qlogo.cn/mmopen/bNqVZcia7iaBxCFc2DfTGPtzbsfSPUqdBGribTiaXuCnWyNJDtfNBwcicCs0ZtxtaTZrGf4Z2S8mqqKKa69hw8eOJsw/132)
