...
* 3. [性能优化建议](#-1)
	...
	* 3.3. [索引相关的数据结构和算法](#-1)
		* 3.3.1. [二叉查找树和平衡二叉树](#-1)
		* 3.3.2. [平衡二叉树旋转](#-1)
		* 3.3.3. [简化B+Tree](#BTree)
	* 3.4. [特定类型查询优化](#-1)
		* 3.4.1. [优化COUNT()查询](#COUNT)
		* 3.4.2. [优化关联查询](#-1)
		* 3.4.3. [优化LIMIT分页](#LIMIT)
		* 3.4.4. [优化UNION](#UNION)
		* 3.4.5. [思考](#-1)
* 4. [其它奇技淫巧总结](#-1)
...
![索引如何组织数据存储图](images/索引如何组织数据存储.png)
...
###  3.4. <a name='-1'></a>特定类型查询优化
####  3.4.1. <a name='COUNT'></a>优化COUNT()查询
...
####  3.4.3. <a name='LIMIT'></a>优化LIMIT分页
...
> [由B-/B+树看 MySQL索引结构](https://segmentfault.com/a/1190000004690721)  
> [其它奇技淫巧总结.10条MySQL优化语句](https://www.cnblogs.com/jxldjsn/p/6010720.html)
>《高性能MySQL（第三版）》Baron Scbwartz等著，宁海元 周振兴等译； 电子工业出版社，2013  
> 《MySQL技术内幕-InnoDB存储引擎》; 姜承尧 著；机械工业出版社，2013